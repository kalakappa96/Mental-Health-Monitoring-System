			...
			<div class="app-content">
				...
				<div class="main-content" >
					...
					<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle"><b><u>Add  Doctor  Specialization</u></b></h1>
									</div>
							</div>
						</section>
						<div class="container-fluid container-fullw bg-white">
													...
													<form role="form" name="dcotorspcl" method="post" >
														<div class="form-group">
															<label for="exampleInputEmail1">
																<b>Enter Doctor Specialization</b>
															</label>
							<input type="text" name="doctorspecilization" class="form-control"  placeholder="Enter Doctor Specialization">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15"> <span class="text-bold">Manage Docter Specialization</span></h5>
