				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle"><b><u>Edit Doctor Details</b></u></h1>
																	</div>
								</div>
						</section>
						<!-- end: PAGE TITLE -->
...
{
?>
<h4><b>Dr. </b><?php echo htmlentities($data['doctorName']);?>'s Profile</h4>
...
<div class="form-group">
															<label for="address">
																 <b>3.Doctor Clinic Address</b>
															</label>
					<textarea name="clinicaddress" class="form-control"><?php echo htmlentities($data['address']);?></textarea>
														</div>
<div class="form-group">
															<label for="fess">
																<b>4.Doctor Consultancy Fees</b>
															</label>
