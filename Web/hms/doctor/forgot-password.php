	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../index.html"><h2><b>Doctor Password Recovery</b></h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							...
							<div class="form-group form-actions"><b>1.Enter Registred Mobile Number</b>
							...
							<div class="form-group"><b>2.Enter Registred Email-ID</b>
								<span class="input-icon">
