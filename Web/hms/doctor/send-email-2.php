...
function sendEmail($userEmailAdderess) 
{
    ...
    try {
        ...
        $mail->Subject = 'Booking Appointment Cancellation';
        $mail->Body    = 'Your Appointment Has been cancelled By Doctor';
